...
- Generated: 2026-04-13T14:35:39.834657+00:00
...
- Operating points: `45`
- Raw CSV: `F:/gpu experiment/SRAM_nosie_simulation-GPU-experiment/reports/ops_plan_v1/ops_plan_v1_full/parallel/workers_4/repeat_1/results/spice_vs_native_pdk_gf180mcu_matrix_parallel_w4_r1.csv`
...
- Mean SPICE runtime per operating point (ms): `4295.540927`
- Mean SPICE runtime per MC sample (ms): `4295.540927`
- Mean Native runtime per operating point (ms): `315.931353`
...
|---|---:|
| MAE(SNM mV) | 7.454834 |
| MAE(SNM mV raw-native) | 269.047007 |
| MAE(noise) | 0.002418 |
| MAE(BER) | 0.002035 |
| MAE(log10 BER) | 0.002177 |
| Max |delta BER| | 0.005185 |
| MAE(BER raw-native) | 0.594067 |
| MAE(log10 BER raw-native) | 0.391607 |
| Max |delta BER| raw-native | 0.602220 |
| MAE(BER contract) | 0.002035 |
| MAE(log10 BER contract) | 0.002177 |
| Max |delta BER| contract | 0.005185 |
| MAE(Hold SNM mV) | 7.454834 |
| MAE(Read SNM mV) | 7.879256 |
| MAE(Write Margin mV) | 59.810327 |
| MAE(Noise Sigma) | 0.002418 |
| MAE(Noise Sigma raw-native) | 0.637520 |
| MAE(Read Fail) | 0.000000 |
| MAE(Read Fail raw-native) | 0.999753 |
...
|---|---|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---:|
| snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 26.629396 | 45 | no | no | usable | fitted | 0 | 15 | 0.487822 | 273.812069 | 45 |
| hold_snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 26.629396 | 45 | no | no | usable | fitted | 0 | 15 | 0.487822 | 273.812069 | 45 |
| read_snm_mv | n/a | spice_read_snm_mv_raw | 1855.079870 | 45 | no | no | usable | fitted | 0 | 15 | 0.002987 | 274.471338 | 45 |
| write_margin_mv | n/a | spice_write_margin_mv_raw | 1827.645000 | 45 | no | no | usable | fitted | 0 | 15 | 0.014353 | 1731.911392 | 45 |
| noise | n/a | spice_noise_raw | 0.497127 | 45 | no | no | usable | fitted | 0 | 15 | 0.014876 | 0.043113 | 45 |
| noise_sigma | n/a | spice_noise_sigma_raw | 0.497127 | 45 | no | no | usable | fitted | 0 | 15 | 0.014876 | 0.043113 | 45 |
