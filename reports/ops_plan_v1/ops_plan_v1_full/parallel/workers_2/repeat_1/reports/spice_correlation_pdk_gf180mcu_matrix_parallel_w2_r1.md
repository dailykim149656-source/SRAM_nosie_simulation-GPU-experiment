...
- Generated: 2026-04-13T14:32:31.131009+00:00
...
- Operating points: `45`
- Raw CSV: `F:/gpu experiment/SRAM_nosie_simulation-GPU-experiment/reports/ops_plan_v1/ops_plan_v1_full/parallel/workers_2/repeat_1/results/spice_vs_native_pdk_gf180mcu_matrix_parallel_w2_r1.csv`
...
- Mean SPICE runtime per operating point (ms): `2895.554373`
- Mean SPICE runtime per MC sample (ms): `2895.554373`
- Mean Native runtime per operating point (ms): `153.492389`
...
|---|---:|
| MAE(SNM mV) | 9.215700 |
| MAE(SNM mV raw-native) | 267.056990 |
| MAE(noise) | 0.002145 |
| MAE(BER) | 0.002517 |
| MAE(log10 BER) | 0.002688 |
| Max |delta BER| | 0.005276 |
| MAE(BER raw-native) | 0.594015 |
| MAE(log10 BER raw-native) | 0.391585 |
| Max |delta BER| raw-native | 0.602219 |
| MAE(BER contract) | 0.002517 |
| MAE(log10 BER contract) | 0.002688 |
| Max |delta BER| contract | 0.005276 |
| MAE(Hold SNM mV) | 9.215700 |
| MAE(Read SNM mV) | 9.275236 |
| MAE(Write Margin mV) | 78.994373 |
| MAE(Noise Sigma) | 0.002145 |
| MAE(Noise Sigma raw-native) | 0.609810 |
| MAE(Read Fail) | 0.000000 |
| MAE(Read Fail raw-native) | 0.999760 |
...
|---|---|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---:|
| snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 48.753722 | 45 | no | no | usable | fitted | 0 | 15 | 0.388192 | 273.966470 | 45 |
| hold_snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 48.753722 | 45 | no | no | usable | fitted | 0 | 15 | 0.388192 | 273.966470 | 45 |
| read_snm_mv | n/a | spice_read_snm_mv_raw | 1847.976610 | 45 | no | no | usable | fitted | 0 | 15 | -0.001365 | 270.962884 | 45 |
| write_margin_mv | n/a | spice_write_margin_mv_raw | 1835.242000 | 45 | no | no | usable | fitted | 0 | 15 | 0.003913 | 1743.163012 | 45 |
| noise | n/a | spice_noise_raw | 0.499778 | 45 | no | no | usable | fitted | 0 | 15 | -0.006551 | 0.057736 | 45 |
| noise_sigma | n/a | spice_noise_sigma_raw | 0.499778 | 45 | no | no | usable | fitted | 0 | 15 | -0.006551 | 0.057736 | 45 |
