...
- Generated: 2026-04-13T14:34:18.570568+00:00
...
- Operating points: `45`
- Raw CSV: `F:/gpu experiment/SRAM_nosie_simulation-GPU-experiment/reports/ops_plan_v1/ops_plan_v1_full/parallel/workers_2/repeat_2/results/spice_vs_native_pdk_gf180mcu_matrix_parallel_w2_r2.csv`
...
- Mean SPICE runtime per operating point (ms): `2959.435804`
- Mean SPICE runtime per MC sample (ms): `2959.435804`
- Mean Native runtime per operating point (ms): `165.813760`
...
|---|---:|
| MAE(SNM mV) | 9.156995 |
| MAE(SNM mV raw-native) | 268.802178 |
| MAE(noise) | 0.002125 |
| MAE(BER) | 0.002500 |
| MAE(log10 BER) | 0.002674 |
| Max |delta BER| | 0.005301 |
| MAE(BER raw-native) | 0.594058 |
| MAE(log10 BER raw-native) | 0.391603 |
| Max |delta BER| raw-native | 0.602219 |
| MAE(BER contract) | 0.002500 |
| MAE(log10 BER contract) | 0.002674 |
| Max |delta BER| contract | 0.005301 |
| MAE(Hold SNM mV) | 9.156995 |
| MAE(Read SNM mV) | 8.707733 |
| MAE(Write Margin mV) | 84.546301 |
| MAE(Noise Sigma) | 0.002125 |
| MAE(Noise Sigma raw-native) | 0.651765 |
| MAE(Read Fail) | 0.000000 |
| MAE(Read Fail raw-native) | 0.999794 |
...
|---|---|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---:|
| snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 39.503918 | 45 | no | no | usable | fitted | 0 | 15 | 0.475888 | 273.806584 | 45 |
| hold_snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 39.503918 | 45 | no | no | usable | fitted | 0 | 15 | 0.475888 | 273.806584 | 45 |
| read_snm_mv | n/a | spice_read_snm_mv_raw | 1864.422430 | 45 | no | no | usable | fitted | 0 | 15 | -0.003221 | 269.186202 | 45 |
| write_margin_mv | n/a | spice_write_margin_mv_raw | 1827.538000 | 45 | no | no | usable | fitted | 0 | 15 | 0.011696 | 1734.916102 | 45 |
| noise | n/a | spice_noise_raw | 0.502978 | 45 | no | no | usable | fitted | 0 | 15 | -0.011458 | 0.061471 | 45 |
| noise_sigma | n/a | spice_noise_sigma_raw | 0.502978 | 45 | no | no | usable | fitted | 0 | 15 | -0.011458 | 0.061471 | 45 |
