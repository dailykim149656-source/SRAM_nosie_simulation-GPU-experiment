...
- Generated: 2026-04-13T14:39:14.484481+00:00
...
- Operating points: `45`
- Raw CSV: `F:/gpu experiment/SRAM_nosie_simulation-GPU-experiment/reports/ops_plan_v1/ops_plan_v1_full/parallel/workers_8/repeat_2/results/spice_vs_native_pdk_gf180mcu_matrix_parallel_w8_r2.csv`
...
- Mean SPICE runtime per operating point (ms): `7215.301256`
- Mean SPICE runtime per MC sample (ms): `7215.301256`
- Mean Native runtime per operating point (ms): `622.413147`
...
|---|---:|
| MAE(SNM mV) | 7.015619 |
| MAE(SNM mV raw-native) | 271.163763 |
| MAE(noise) | 0.002130 |
| MAE(BER) | 0.001916 |
| MAE(log10 BER) | 0.002047 |
| Max |delta BER| | 0.005969 |
| MAE(BER raw-native) | 0.594061 |
| MAE(log10 BER raw-native) | 0.391605 |
| Max |delta BER| raw-native | 0.602217 |
| MAE(BER contract) | 0.001916 |
| MAE(log10 BER contract) | 0.002047 |
| Max |delta BER| contract | 0.005969 |
| MAE(Hold SNM mV) | 7.015619 |
| MAE(Read SNM mV) | 6.792471 |
| MAE(Write Margin mV) | 59.197933 |
| MAE(Noise Sigma) | 0.002130 |
| MAE(Noise Sigma raw-native) | 0.686795 |
| MAE(Read Fail) | 0.000000 |
| MAE(Read Fail raw-native) | 0.999911 |
...
|---|---|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---:|
| snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 40.683046 | 45 | no | no | usable | fitted | 1 | 15 | 0.872875 | 272.077379 | 45 |
| hold_snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 40.683046 | 45 | no | no | usable | fitted | 1 | 15 | 0.872875 | 272.077379 | 45 |
| read_snm_mv | n/a | spice_read_snm_mv_raw | 1870.391970 | 45 | no | no | usable | fitted | 0 | 15 | -0.003486 | 268.474899 | 45 |
| write_margin_mv | n/a | spice_write_margin_mv_raw | 1834.280000 | 45 | no | no | usable | fitted | 0 | 15 | 0.040375 | 1700.744762 | 45 |
| noise | n/a | spice_noise_raw | 0.507637 | 45 | no | no | usable | fitted | 0 | 15 | -0.003497 | 0.055980 | 45 |
| noise_sigma | n/a | spice_noise_sigma_raw | 0.507637 | 45 | no | no | usable | fitted | 0 | 15 | -0.003497 | 0.055980 | 45 |
