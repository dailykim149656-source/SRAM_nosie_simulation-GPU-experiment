...
- Generated: 2026-04-13T14:38:07.631355+00:00
...
- Operating points: `45`
- Raw CSV: `F:/gpu experiment/SRAM_nosie_simulation-GPU-experiment/reports/ops_plan_v1/ops_plan_v1_full/parallel/workers_8/repeat_1/results/spice_vs_native_pdk_gf180mcu_matrix_parallel_w8_r1.csv`
...
- Mean SPICE runtime per operating point (ms): `7330.903284`
- Mean SPICE runtime per MC sample (ms): `7330.903284`
- Mean Native runtime per operating point (ms): `620.279329`
...
| Metric | Value |
|---|---:|
| MAE(SNM mV) | 10.237751 |
| MAE(SNM mV raw-native) | 266.870776 |
| MAE(noise) | 0.001779 |
| MAE(BER) | 0.002793 |
| MAE(log10 BER) | 0.002994 |
| Max |delta BER| | 0.009228 |
| MAE(BER raw-native) | 0.594044 |
| MAE(log10 BER raw-native) | 0.391597 |
| Max |delta BER| raw-native | 0.602221 |
| MAE(BER contract) | 0.002793 |
| MAE(log10 BER contract) | 0.002994 |
| Max |delta BER| contract | 0.009228 |
| MAE(Hold SNM mV) | 10.237751 |
| MAE(Read SNM mV) | 7.120281 |
| MAE(Write Margin mV) | 72.414846 |
| MAE(Noise Sigma) | 0.001779 |
| MAE(Noise Sigma raw-native) | 0.662086 |
| MAE(Read Fail) | 0.000000 |
| MAE(Read Fail raw-native) | 0.999796 |
...
|---|---|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---:|
| snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 47.282891 | 45 | no | no | usable | fitted | 1 | 15 | 0.273650 | 275.209096 | 45 |
| hold_snm_mv | spice_snm_mv_raw | spice_snm_mv_raw | 47.282891 | 45 | no | no | usable | fitted | 1 | 15 | 0.273650 | 275.209096 | 45 |
| read_snm_mv | n/a | spice_read_snm_mv_raw | 1866.831890 | 45 | no | no | usable | fitted | 0 | 15 | 0.001405 | 273.253143 | 45 |
| write_margin_mv | n/a | spice_write_margin_mv_raw | 1811.030000 | 45 | no | no | usable | fitted | 0 | 15 | 0.017724 | 1726.951673 | 45 |
| noise | n/a | spice_noise_raw | 0.493657 | 45 | no | no | usable | fitted | 0 | 15 | 0.015891 | 0.042022 | 45 |
| noise_sigma | n/a | spice_noise_sigma_raw | 0.493657 | 45 | no | no | usable | fitted | 0 | 15 | 0.015891 | 0.042022 | 45 |
