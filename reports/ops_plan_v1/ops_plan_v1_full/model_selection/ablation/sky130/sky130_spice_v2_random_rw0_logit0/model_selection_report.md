...
- Generated: 2026-04-13T14:01:00.525294+00:00
...
|---:|---|---:|---:|---:|---:|---:|
| 1 | Random Forest | 0.855556 | 6.331671 | 0.324507 | 3670 | yes |
| 2 | MLP 2-layer (Perceptron Gate) | 0.832163 | 7.058925 | 0.000692 | 181 | yes |
| 3 | Polynomial (deg=3) | 0.806957 | 6.805193 | 0.004777 | 120 | no |
| 4 | Polynomial (deg=2) | 0.788405 | 8.572574 | 0.004511 | 36 | no |
| 5 | Linear Regression | 0.770560 | 7.661526 | 0.001473 | 8 | no |
| 6 | Gradient Boosting | 0.741797 | 7.870268 | 0.006816 | 1540 | no |
| 7 | SVR (RBF) | 0.549367 | 9.997970 | 0.006840 | 0 | no |
| 8 | MLP 3-layer (sklearn) | -1.191877 | 7.841345 | 0.006723 | 505 | no |
...
- Rule step 1 (quality): Pareto models with R2 >= `0.835556` (best Pareto R2 `0.855556` - tolerance `0.020000`)
- Rule step 2 (speed): among quality candidates, keep models within `0.649014` ms/sample (2.00x fastest quality latency), then choose best R2

| Target | R2 | RMSE | MAE |
|---|---:|---:|---:|
| snm | 0.744597 | 7.077386 | 5.814576 |
| ber | 0.744394 | 0.001710 | 0.001400 |
...
| read_fail | 0.999992 | 0.000000 | 0.000000 |
...
| ber | 0.001400 | 0.001114 | 0.001753 |
