...
- Generated: 2026-04-13T14:14:40.233584+00:00
...
|---:|---|---:|---:|---:|---:|---:|
| 1 | MLP 3-layer (sklearn) | 0.597849 | 10.580832 | 0.009193 | 505 | yes |
| 2 | MLP 2-layer (Perceptron Gate) | 0.597835 | 10.188822 | 0.001054 | 181 | yes |
| 3 | Random Forest | 0.570329 | 10.145474 | 0.612612 | 3968 | no |
| 4 | Linear Regression | 0.560439 | 10.232550 | 0.001330 | 8 | no |
| 5 | Polynomial (deg=2) | 0.542873 | 11.166763 | 0.004823 | 36 | no |
| 6 | Gradient Boosting | 0.440642 | 13.007622 | 0.010216 | 1540 | no |
| 7 | Polynomial (deg=3) | 0.420172 | 12.906920 | 0.005602 | 120 | no |
| 8 | SVR (RBF) | 0.179903 | 13.949708 | 0.007078 | 0 | no |
...
- Rule step 1 (quality): Pareto models with R2 >= `0.577849` (best Pareto R2 `0.597849` - tolerance `0.020000`)
- Rule step 2 (speed): among quality candidates, keep models within `0.002107` ms/sample (2.00x fastest quality latency), then choose best R2

| Target | R2 | RMSE | MAE |
|---|---:|---:|---:|
| snm | 0.612583 | 8.383673 | 7.534775 |
| ber | 0.626062 | 0.002248 | 0.002058 |
...
| ber | 0.002058 | 0.001758 | 0.002360 |
