...
- Generated: 2026-04-13T14:13:55.899880+00:00
...
|---:|---|---:|---:|---:|---:|---:|
| 1 | Random Forest | 0.267169 | 10.454917 | 0.435944 | 4258 | yes |
| 2 | MLP 2-layer (Perceptron Gate) | 0.140108 | 10.472912 | 0.000605 | 181 | yes |
| 3 | Polynomial (deg=2) | 0.095034 | 11.410014 | 0.005577 | 36 | no |
| 4 | Linear Regression | 0.029547 | 10.562786 | 0.001548 | 8 | no |
| 5 | Gradient Boosting | -0.090151 | 13.567083 | 0.008418 | 1540 | no |
| 6 | Polynomial (deg=3) | -0.245401 | 14.130657 | 0.007503 | 120 | no |
| 7 | SVR (RBF) | -0.460377 | 13.764885 | 0.006466 | 0 | no |
| 8 | MLP 3-layer (sklearn) | -1.962598 | 11.198824 | 0.008342 | 505 | no |
...
- Rule step 1 (quality): Pareto models with R2 >= `0.247169` (best Pareto R2 `0.267169` - tolerance `0.020000`)
- Rule step 2 (speed): among quality candidates, keep models within `0.871888` ms/sample (2.00x fastest quality latency), then choose best R2
